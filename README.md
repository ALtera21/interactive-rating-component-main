...
It is so worth it to spend 2 days to do this challenge
...
- [getcssscan](https://getcssscan.com/css-box-shadow-examples) - i used this website if i wanted to copy paste a shadow style
